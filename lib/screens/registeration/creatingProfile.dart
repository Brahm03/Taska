                      ...
                      Stack(
                        children: [
                          CircleAvatar(
                            ...
                            child: Center(
                                child:
                                    context.watch<EditProfileImage>().image ==
                                            null
                                        ? Padding(
                                            padding: PMconst.medium,
                          ...
                          Positioned(
                              ...
                              child: IconButton(
                                ...
                                onPressed: () async {
                                  await context
                                      .read<EditProfileImage>()
                                      .pickImage();
                                  context.read<UserInfoProvider>().addIMGtoDB(
                                      Provider.of<EditProfileImage>(context,
                                              listen: false)
                                          .image!);
                                },
                              ))
